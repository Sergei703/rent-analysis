...
👉 **[Open interactive map](https://Sergei703.github.io/rent-analysis/charts/09_offers_map.html)**
...
**3. Последние этажи демонстрируют ценовой дисконт.**
...
**4. Цена за м² и абсолютная стоимость аренды дают разные представления о привлекательности объекта.**
...
**5. Одинаковая месячная цена не означает одинаковую ценность предложения.**
...
**6. Структура площади меняется в зависимости от комнатности.**
У 1-комнатных квартир медианная доля кухни составляет 23% общей площади, тогда как у 3-комнатных — 13%. Доля жилой площади при этом увеличивается с 56% до 70%.

**7. 39% объявлений не требуют залога.**
...
**8. Цена аренды заметно зависит от удалённости от центра города.**
54% объявлений находятся в радиусе 2 км от центра, где цена за м² в среднем на 65% выше, чем за пределами 5 км.
...
### Распределение предложений и цены по комнатности

![offers_and_price_by_rooms](charts/02_offers_and_price_by_rooms.png)

### Цена за м² по возрасту дома

![price_by_building_era](charts/05_price_by_building_era.png)

### Цена за м² по расположению этажа

![price_by_floor_segment](charts/03_price_by_floor_segment.png)

Остальные графики и подробный разбор каждой таблицы — в [`INSIGHTS.md`](./INSIGHTS.md).
...
* Выявленные различия являются описательными и не доказывают причинное влияние отдельных характеристик на цену.
